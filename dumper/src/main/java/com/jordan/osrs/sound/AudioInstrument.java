...
import com.jordan.osrs.util.ByteBufferUtils;
...
public class AudioInstrument {
	...
	final void decode(ByteBuffer var1) {
		...
		for (int var3 = 0; var3 < 10; ++var3) {
			int var4 = ByteBufferUtils.getUSmart(var1);
			if (var4 == 0) {
				break;
			}

			this.oscillatorVolume[var3] = var4;
			this.oscillatorPitch[var3] = ByteBufferUtils.getShortSmart(var1);
			this.oscillatorDelays[var3] = ByteBufferUtils.getUSmart(var1);
		}

		this.delayTime = ByteBufferUtils.getUSmart(var1);
		this.delayDecay = ByteBufferUtils.getUSmart(var1);
